...
t, dto = cv2.threshold(gray, 170, 255, cv2.THRESH_TOZERO)#Cualquier pixel cuya intensidad no supere el umbral se establecerá a cero
t, dtoi = cv2.threshold(gray, 170, 255, cv2.THRESH_TOZERO_INV)#Cualquier pixel cuya intensidad no supere el umbral se establecerá a cero invertido
t, pti = cv2.threshold(gray, 0, 255, cv2.THRESH_BINARY | cv2.THRESH_TRIANGLE) #Optimo
...
cv2.imshow('Binario_Cero', dto)#Muestra Imagen Binario Invertido
cv2.imwrite("Binario_Cero.tif",dto)#Guarda Imagen Binario Invertido
cv2.imshow('Binario_CeroInvertido', dtoi)#Muestra Imagen Binario Invertido
cv2.imwrite("Binario_CeroInvertido.tif",dtoi)#Guarda Imagen Binario Invertido
cv2.imshow('Binario_Optimo', pti)#Muestra Imagen Binario Invertido
cv2.imwrite("Binario_Optimo.tif",pti)#Guarda Imagen Binario Invertido
