...
f = open("Neurona_InfoRXYZ-"+str(st)+".txt",'a')
...
for line in lines:
    x1, y1, x2, y2 = line[0]
    cv2.line(img, (x1, y1), (x2, y2), (0, 0, 255), 4)#Azul Verde Rojo 4Ancho
    if x1==x2:
    	cv2.circle(img,(x2, y2), 6, (255,255,0), 6)#Circulo azulverde
    if y1==y2:
    	cv2.circle(img,(x2, y2), 6, (250,0,250), 6)#Circulo rosa
    cv2.circle(img,(x2, y2), 5, (255,0,0), 2)#Circulo Azul
    cv2.circle(img,(x1, y1), 5, (0,200,0), 2)#Circulo verde    
...
cv2.imwrite("DenNeuronaNodosOrig33.tif",img)#Guarda Imagen Binario Invertido
